/* 1. Using a subquery, find the names of all the tracks for the
...
-- 3. Retrieve the track name, album, artist, and trackID for 
-- all the albums.
...
------------------------------------------------------------------------------------
-- 6. Use a UNION to create a list of all the employee's & 
